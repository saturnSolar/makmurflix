...
function displayMovie(data) {
    ...
    if (movie) {
      container.style.background = `linear-gradient(to bottom, rgba(0, 0, 0, .8), rgba(0, 0, 0, .1) 30%),
        linear-gradient(to top, rgba(0, 0, 0, .8), rgba(0, 0, 0, .4)),
        linear-gradient(to right, rgba(0, 0, 0, .8), rgba(0, 0, 0, .1) 30%),
        linear-gradient(to left, rgba(0, 0, 0, .8), rgba(0, 0, 0, .1) 30%),url(${movie.thumb})`;
